		...
		<div class="sidecol mt">
    		...
    		<div class="col-md-9">
    			...
    			<ul class="breadcrumb">
					...
					<li><a href="prefixes.jsp">Prefixes</a></li>
    			...
    			<div class="headlinetransaction">
    				...
    				<table class="table table-striped">
				        ...
				        <tbody>
							 ...
							 <tr>
							 <td>
				        <form class="contatct" action="transact" method="post">
				        	<input type="hidden" name="purchaseType" value="purchaseLoad">
							<input type="submit" class="btn btn-primary btn-sm" value="PURCHASE LOAD" onclick="return confirm('Are you sure?')">	
							<a class="btn btn-default btn-sm" href="prefixes.jsp">Back</a>	
						</form></td>
				       </tr> 
				        </tbody>
