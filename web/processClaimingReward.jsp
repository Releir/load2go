		...
		<div class="sidecol mt">
    		...
    		<div class="col-md-9">
    			...
    			<ul class="breadcrumb">
					...
					<li><a href="claimReward.jsp">Claim Reward</a></li>
					<li class="active">Confirmation(Reward)&nbsp;</li>
				</ul>
    			<hr>
				<s:if test="hasActionErrors()">
	   				<div class="alert alert-danger">
	      				<s:actionerror/>
	      				Click <a href="claimReward.jsp">here</a> to go back!
	   				</div>
				</s:if>
				<s:else>
    			<div class="headlinetransaction">
    				...
    				<table class="table table-striped">
				        ...
				        <tbody>
				                <tr>
				                    <td>CLAIM REWARD POINTS</td>
				                    <td>
				                        POINTS: ${rewards_transaction.amount}
				                    </td>
				                </tr>
							 <tr>
							 <td>
				        <form action="claim" method="post">
							<input type="submit" class="btn btn-warning btn-sm" value="CLAIM REWARD" onclick="return confirm('Are you sure?')">
							<a class="btn btn-default btn-sm" href="claimReward.jsp">Back</a>		
						</form></td>
				       </tr> 
				        </tbody>
